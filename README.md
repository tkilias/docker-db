...
Due to the configuration of permission management, shared memory and hugepages, the cluster can currently only be started in Docker privileged mode. The support for non-privileged mode is in progress.
