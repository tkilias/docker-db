...
import re, base64, string, random, os, subprocess, time, shutil, hashlib, uuid, crypt
...
# {{{ define supported duration scale options - currently till weeks
class TimeScale:
    WEEK = 0
    DAY = 1
    HOUR = 2
...
# This utility will search all scalers one by one and sum them up
